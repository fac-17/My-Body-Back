  ...
  return (
    <div className="welcome__container">
      ...
      <div className="welcome__icon__container">
        ...
        <p className="welcome__text">
           My Appointment section will help you to get prepared and open yourself, as a flower to professionals which will guide through in the path of acceptance and feeling better
        </p>
      </div>
      <div className="welcome__icon__container">
