...
const About = () => {
    ...
    <div>
        <Header />
        <div className="about__container" data-testid="about-header">
            <h1 className="about__header">About this App</h1>
            <p className="about__text__main">This app is not about making you go for a cervical screening before you are ready, but about helping you to take small steps, in your own time.  You may even decide that you don’t want to have a smear test at all.   You have the right to make this choice.</p>
            <p className="about__text__main">Our app is all about helping you to be more compassionate towards yourself.</p>
