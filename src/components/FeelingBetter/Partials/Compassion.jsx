    ...
    <section id="compassion-section__container">
      <Swipeable onSwipedLeft={swipingLeft} onSwipedRight={swipingRight}>
        <section id="compassion-section-page__one">
          ...
          >
            <p>
              As human beings, we all need to feel cared for, protected and
              valued. Humans have a compassionate instinct... for others. We
              feel good when we help someone else, and when someone else is kind
              and caring to us. Yet we often struggle to show compassion to
              ourselves. But with practice, we can use our natural ability to
              feel compassion, and direct it inwards. Compassion helps to create
              a balance between the threat, drive and soothing systems.
            </p>
          </section>
        </section>
          ...
          >
            <h3>Other Ways to Build Self Compassion</h3>
              ...
              <p>
                ...
                this moment. Try not to push your feelings away; instead,
                observe them and remind yourself that it is ok to feel them. It
              ...
              <p>
                ...
                them. It is very easy to fall into patterns of self-critical
              ...
              <ul>
                Ask yourself:
                <li>
                  What would I say to a friend in my situation? How would my
                  voice sound? What would my wishes be for them?
                </li>
      ...
      <span onClick={swipingRight} className="compassion__arrow__left">
        {" "}
        ⟵{" "}
      </span>
      <span onClick={swipingLeft} className="compassion__arrow__right">
        {" "}
        ⟶{" "}
      </span>
    </section>
